        ...
        <div class="col-md-3 col-lg-2">
            <div class="sq-sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="ecran_appel.php" target="_blank">
                        <i class="bi bi-display me-2"></i>Écran d'appel
                    </a>
                </nav>
            </div>
        </div>
            ...
            <?php if ($guichet['statut'] === 'ouvert' && !$currentTicket && !empty($waitingTickets)): ?>
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <?php if ($waitingTickets[0]['priorite'] === 'urgent'): ?>
                            <span class="badge bg-danger mb-3"><i class="bi bi-lightning-fill me-1"></i>Urgent</span>
                        <?php endif; ?>
                        <div class="d-flex justify-content-center gap-2 mt-2">
                            <a href="appel_ticket.php?action=call&id=<?= $waitingTickets[0]['id'] ?>"
                               class="btn btn-success btn-lg px-4">
                                <i class="bi bi-megaphone me-2"></i>Appeler ce ticket
                            </a>
                            <a href="appel_ticket.php?action=call_next"
                               class="btn btn-outline-success btn-lg"
                               title="Appeler automatiquement le ticket urgent ou le plus ancien">
                                <i class="bi bi-skip-forward-fill me-1"></i>Suivant auto
                            </a>
                        </div>
                        <p class="text-muted mt-3 mb-0" style="font-size:.85rem">
                            <i class="bi bi-info-circle me-1"></i>
                            L'appel sera affiché sur l'<a href="ecran_appel.php" target="_blank">écran de salle d'attente</a>.
                        </p>
                    </div>
                </div>
